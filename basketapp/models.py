...
class Basket(models.Model):
    ...
    @staticmethod
    def get_items(user):
        return user.basket.select_related().order_by('accommodation__kindergarden')
